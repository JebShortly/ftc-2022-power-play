...
public class ConstantsV4 {
    ...
    // Servo Constants
    public static final double PINCHER_POS =  0.15;     //pincher fully latched
    ...
    // Turntable Constants
    public static final double TURNTABLE_POW = 0.4;     //pow for both left and right

    // Tilt Constants
    public static final double TILT_UP_POW = 0.5;
    public static final double TILT_DOWN_POW = -0.1;
    public static final double TILT_IDLE_POW = 0.6;     //pow given to RUN_TO_POSITION to stabilize motor
